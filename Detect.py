...
class Detector:
    ...
    def drawBoxes(self)->None:
        for img in self.results:
            ...
            plt.xticks([])
            plt.yticks([])
            plt.savefig("/content/gdrive/MyDrive/cell tower/predictions/images/celldetection_th={}_{}".format(self.threshold, self.removePrefix(img)))
        return
    ...
    def drawHeatmap(self, probaMap:list)->None:
        ...
        for img in self.zones:
            ...
            plt.savefig("/content/gdrive/MyDrive/cell tower/predictions/images/heatmaps/heatmap_{}".format(self.removePrefix(img)))
...
if __name__ == "__main__":
    ...
    path2Weights = "/content/gdrive/MyDrive/cell tower/predictions/weights/best_weights_baseline_3.h5"
    trainFile = "Train.py"
    ...
    zonesPath = "/content/gdrive/MyDrive/cell tower/data/zones"
    ...
    with open("/content/gdrive/MyDrive/cell tower/predictions/results.json","w") as f:
